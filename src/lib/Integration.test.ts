...
class MockAdapter implements EditorAdapter {
    ...
    getSelection() { return ""; }
    replaceSelection(t: string) { this.content = t; }
    replaceText(t: string) { this.content = t; }
    insertAtCursor(t: string) { this.content += t; }
}
...
describe('Real Script Integration Test', () => {
    ...
    it('SHA256.js: hashes text using jshashes', () => {
        ...
        // SHA256 of "hello"
        expect(adapter.content).toBe("2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824");
    });
